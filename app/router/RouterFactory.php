...
class RouterFactory
{
	...
	private $oldUrls = [
		...
		'en/setting-up-defaults-to-edit-form ='> NULL,
		'en/tinymce-installation' => 136,
		'en/different-layout-in-administration' => 82,
		'en/helper-loader ='> NULL,
		'en/macro-loader ='> NULL,
		'en/how-open-files-in-ide-from-debugger' => 77,
		'en/loading-models-with-notorm-and-dependency-injection ='> NULL,
		'en/dependent-form-select-with-ajax ='> NULL,
		...
		'cs/posobota-22-predstavovani-se ='> NULL,
		'cs/posobota-22-radek-pavlicek-pristupnost-nette-aplikaci ='> NULL,
		'cs/posobota-22-roman-kabelka-pristupnost-nette-aplikaci-v-praxi ='> NULL,
		'cs/posobota-25-jiri-koutny-rozjizdime-php-v-amazon-cloudu ='> NULL,
		'cs/posobota-25-josef-kriz-venne-cms ='> NULL,
		'cs/posobota-25-predstavovani-se '=> 182,
		'cs/posobota-29-david-grudl-predstavuje-nette-2-0-beta '=> 185,
		'cs/posobota-29-jakub-kohout-a-patrik-votocek-nella-cms ='> NULL,
		'cs/posobota-29-mikulas-dite-haml-filter ='> NULL,
		'cs/posobota-29-pavel-ptacek-lightbulb ='> NULL,
		'cs/posobota-30-petr-prochazka-phpunit-html-interface ='> NULL,
		'cs/posobota-30-predstavovani-se ='> NULL,
		'cs/posobota-30-vitek-jezek-selenium ='> NULL,
		'cs/posobota-36-blahoprani-jakuba-vrany ='> NULL,
		...
		'cs/posobota-36-jan-smitka-routovani ='> NULL,
		'cs/posobota-36-jan-tvrdik-komponenty ='> NULL,
		'cs/posobota-36-martin-major-cache ='> NULL,
		'cs/posobota-36-sponzor-klik-pojisteni ='> NULL,
		'cs/posobota-36-uvod-vitka-jezka ='> NULL,
		'cs/posobota-36-vojtech-dobes-ajax-a-snippety ='> NULL,
		'cs/posobota-38-daniel-milde-testovani-nejen-v-phpunitu ='> NULL,
		'cs/posobota-38-david-grudl-dependency-injection ='> NULL,
		'cs/posobota-38-filip-prochazka-composer ='> NULL,
		'cs/posobota-38-jan-smitka-doplnky-v-nette ='> NULL,
		'cs/posobota-38-ondrej-brablc-mlada-fronta ='> NULL,
		...
		'cs/pripojeni-komponenty-k-rodici ='> NULL,
		'cs/routovani-parametr-s-lomitky ='> NULL,
		'cs/routovani-v-cli ='> NULL,
		'cs/routovani-vice-parametru-ve-filtru ='> NULL,
		'cs/sandbox-composer' => 70,
		'cs/staticke-acl' => 89,
		'/post/131-testovani-jednoducheho-controlu ='> NULL,
	...
	public function createRouter($enableSsl = TRUE)
	{
		...
		$frontRouter[] = new Route('<path .+>', [
			NULL => [
				Route::FILTER_IN => function (array $params) {
					if (!isset($params['path'], $this->oldUrls[$params['path']])) {
						return NULL;
					}
					...
					return [
						'presenter' => 'Detail',
						'action' => 'default',
						'id' => $this->oldUrls[$params['path']],
					];
				}
			],
		], Route::$defaultFlags | Route::ONE_WAY);
